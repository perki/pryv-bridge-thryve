...
const dataTypesCSV = ["1000;Steps;Daily;sum of steps;LONG;count/steps",
  ...
  "1013;PhysicalActivityIndex;Daily;PA index;DOUBLE;todo",
  "1100;ActivityDuration;Daily;overall sum of active minutes (all recorded activitites other than sleep, rest, charge, doffed);LONG;time/min",
  "1101;ActivityLowDuration;Daily;sum of minutes spent with light activity;LONG;time/min",
  "1101;ActivityLowBinary;Intraday;low Activity detected (in this minute);NONE;activity/plain",
  "1102;ActivityMidDuration;Daily;sum of minutes spent with medium activity;LONG;time/min",
  "1102;ActivityMidBinary;Intraday;medium Activity detected (in this minute);BOOLEAN;todo",
  "1103;ActivityHighDuration;Daily;sum of minutes spent with high activity;LONG;time/min",
  "1103;ActivityHighBinary;Intraday;high Activity detected (in this minute);BOOLEAN;todo",
  "1104;ActivitySedentaryDuration;Daily;sum of minutes spent sedentary;LONG;time/min",
  "1104;ActivitySedentaryBinary;Intraday;sedentary Activity detected (in this minute);BOOLEAN;todo",
  "1110;ChargeDuration;Daily;sum of minutes spent charging;LONG;time/min",
  "1110;ChargeBinary;Intraday;charge detected (in this minute);NONE;activity/plain",
  "1111;DoffedDuration;Daily;sum of minutes spent doffed;LONG;time/min",
  "1111;DoffedBinary;Intraday;device not worn (in this minute);NONE;activity/plain",
  "1112;SleepDuration;Daily;sum of minutes spent sleeping;LONG;time/min",
  "1112;SleepBinary;Intraday;sleep detected (in this minute);NONE;activity/plain",
  "1113;RestDuration;Daily;sum of minutes spent resting;LONG;time/min",
  "1113;RestBinary;Intraday;rest detected (in this minute);NONE;activity/plain",
  "1114;ActiveDuration;Daily;sum of minutes spent in a generically active state;LONG;time/min",
  "1114;ActiveBinary;Intraday;generic activity detected (in this minute);NONE;activity/plain",
  "1115;WalkDuration;Daily;sum of minutes spent walking;LONG;time/min",
  "1115;WalkBinary;Intraday;walk detected (in this minute);NONE;activity/plain",
  "1116;RunDuration;Daily;sum of minutes spent running;LONG;time/min",
  "1116;RunBinary;Intraday;run detected (in this minute);NONE;activity/plain",
  "1117;BikeDuration;Daily;sum of minutes spent biking;LONG;time/min",
  "1117;BikeBinary;Intraday;biking detected (in this minute);NONE;activity/plain",
  ...
  "2220;SleepRegularity;Daily;Established Indicator describing the likelihood that any two time-points 24 hours apart were the same sleep/wake state, across all days.;LONG;todo",
  "3000;HeartRate;Daily;average heart rate;LONG;frequency/bpm",
  "3000;HeartRate;Intraday;heart rate detected (in this minute);LONG;frequency/bpm",
  ...
  "3300;BloodPressureSystolic;Daily;XXXXXXXXX;DOUBLE;pressure/mmhg",
  "3300;BloodPressureSystolic;Intraday;XXXXXXXXX;DOUBLE;pressure/mmhg",
  "3301;BloodPressureDiastolic;Daily;XXXXXXXXX;DOUBLE;pressure/mmhg",
  "3301;BloodPressureDiastolic;Intraday;XXXXXXXXX;DOUBLE;pressure/mmhg",
  ...
  "5010;AlcoholConsumption;Daily;estimation of alcohol consumption in percentage;LONG;todo",
  "5020;Weight;Daily;weight in kilogram;LONG;mass/kg",
  "5020;Weight;Intraday;weight in kilogram;LONG;mass/kg",
